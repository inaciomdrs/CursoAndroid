...
public class ProdutoDAO {
	...
	private String[] allcolumns = {
		...
		ProdutoEntry.COLUMN_VALOR,  ProdutoEntry.COLUMN_OS_ID,
	};
	...
	public Produto adicionar(Produto produto){
		...
		values.put(ProdutoEntry.COLUMN_OS_ID, produto.getOsID());
	...
	public Produto cursorToProduto(Cursor cursor){
		...
		produto.setOsID(cursor.getLong(1));
		produto.setQuant(cursor.getLong(2));
		produto.setNumero(cursor.getLong(3));
		produto.setValor(cursor.getLong(4));
